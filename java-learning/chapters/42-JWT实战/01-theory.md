# Chapter 42 JWT实战 - 理论篇

## 一、学习定位

本章主题是 **JWT实战**，核心内容包括：Access Token、Refresh Token、拦截器、续签。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“实现登录注册接口”，形成可运行、可演示、可复盘的阶段成果。
