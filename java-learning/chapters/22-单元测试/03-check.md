# Chapter 22 单元测试 - 自测与验收

## 一、概念自测

1. 单元测试 的核心目标是什么？请用不超过 3 句话解释。
2. 本章的关键配置、关键类或关键 SQL 分别是什么？
3. 如果“为工具库补齐自动化测试”运行失败，你会按什么顺序排查？
4. 本章最容易被初学者忽略的边界条件是什么？
5. 它和真实 Java 后端面试有什么关系？

## 二、代码/实操题

1. 独立完成“为工具库补齐自动化测试”的最小版本，不能只复制示例代码。
...
- [ ] 能从零复现本章 Demo。
- [ ] 能讲清 JUnit 5、断言、参数化测试、测试命名 中至少 3 个关键词。
- [ ] 能回答本章 5 个概念自测题。
- [ ] 能把本章内容和博客项目连接起来。
