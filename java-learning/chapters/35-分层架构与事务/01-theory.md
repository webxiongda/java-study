# Chapter 35 分层架构与事务 - 理论篇

## 一、学习定位

本章主题是 **分层架构与事务**，核心内容包括：Controller/Service/Repository、事务边界、业务异常。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“重构博客 API 分层”，形成可运行、可演示、可复盘的阶段成果。
