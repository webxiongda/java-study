# Chapter 26 SQL进阶 - 理论篇

## 一、学习定位

本章主题是 **SQL进阶**，核心内容包括：JOIN、聚合、分页、事务、执行计划入门。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。

- 优先级：L3 面试高频
- 预计投入：4小时
- 阶段产出：完成 10 道 SQL 查询练习
...
- 完成“完成 10 道 SQL 查询练习”，形成可运行、可演示、可复盘的阶段成果。
