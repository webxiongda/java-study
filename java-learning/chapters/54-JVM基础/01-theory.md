# Chapter 54 JVM基础 - 理论篇

## 一、学习定位

本章主题是 **JVM基础**，核心内容包括：内存区域、类加载、GC 概念、常见参数。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
理解 运行时内存 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 2. 类加载

理解 类加载 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 3. GC

理解 GC 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 4. 参数

理解 参数 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 5. 问题排查

理解 问题排查 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。
...
- 完成“整理 JVM 运行观测笔记”，形成可运行、可演示、可复盘的阶段成果。
