...
本章主题是 **配置与环境**，核心内容包括：profile、配置注入、敏感信息、环境隔离。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“建立 dev/prod 配置”，形成可运行、可演示、可复盘的阶段成果。
