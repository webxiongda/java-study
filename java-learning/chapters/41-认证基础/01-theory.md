...
本章主题是 **认证基础**，核心内容包括：Session、JWT、密码哈希、登录流程设计。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“设计注册登录流程”，形成可运行、可演示、可复盘的阶段成果。
