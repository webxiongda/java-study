# Chapter 45 Web安全防护 - 理论篇

## 一、学习定位

本章主题是 **Web安全防护**，核心内容包括：XSS、CSRF、SQL 注入、限流、敏感信息保护。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“输出安全检查清单”，形成可运行、可演示、可复盘的阶段成果。
