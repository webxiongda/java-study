# Chapter 44 SpringSecurity入门 - 理论篇

## 一、学习定位

本章主题是 **SpringSecurity入门**，核心内容包括：Filter Chain、Authentication、Authorization。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。

- 优先级：L1 必须掌握
- 预计投入：4小时
- 阶段产出：接入 Spring Security
...
- 完成“接入 Spring Security”，形成可运行、可演示、可复盘的阶段成果。
...
1. SpringSecurity入门 解决了 Java 后端项目里的什么问题？
2. 如果本章能力在生产环境出问题，你会从哪些日志、配置或数据开始排查？
3. 本章技术和前后章节的关系是什么？例如它如何服务于博客 API 项目？
4. 你在实现“接入 Spring Security”时会如何划分模块，为什么？
