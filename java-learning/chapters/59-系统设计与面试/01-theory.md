...
本章主题是 **系统设计与面试**，核心内容包括：限流、缓存、排行榜、短链、登录系统设计。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
理解 需求拆解 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 2. 容量估算

理解 容量估算 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 3. 限流

理解 限流 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 4. 缓存

理解 缓存 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。
...
- 完成“完成 3 道系统设计题笔记”，形成可运行、可演示、可复盘的阶段成果。
