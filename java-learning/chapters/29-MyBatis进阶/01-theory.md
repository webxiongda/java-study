# Chapter 29 MyBatis进阶 - 理论篇

## 一、学习定位

本章主题是 **MyBatis进阶**，核心内容包括：分页、事务、N+1、批量操作、SQL 日志。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“优化博客查询接口”，形成可运行、可演示、可复盘的阶段成果。
