# Chapter 52 线程池与异步 - 理论篇

## 一、学习定位

本章主题是 **线程池与异步**，核心内容包括：Executor、ThreadPoolExecutor、CompletableFuture。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
理解 线程模型 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 2. 任务提交

理解 任务提交 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 3. 共享变量

理解 共享变量 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 4. 锁

理解 锁 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 5. 可见性

理解 可见性 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。
...
- 完成“实现异步任务执行器”，形成可运行、可演示、可复盘的阶段成果。
