...
本章主题是 **数据库建模**，核心内容包括：一对多、多对多、ER 图、范式、字段设计。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“画出博客系统 ER 模型”，形成可运行、可演示、可复盘的阶段成果。
