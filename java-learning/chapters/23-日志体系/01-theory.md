...
本章主题是 **日志体系**，核心内容包括：SLF4J、Logback、日志级别、日志格式。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“给项目接入标准日志配置”，形成可运行、可演示、可复盘的阶段成果。
