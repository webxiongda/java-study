...
本章主题是 **里程碑：博客APIv1**，核心内容包括：Spring Boot + DB + 文档 + 测试 + GitHub。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“交付可演示博客 API v1”，形成可运行、可演示、可复盘的阶段成果。
