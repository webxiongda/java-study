# Chapter 47 Redis进阶 - 理论篇

## 一、学习定位

本章主题是 **Redis进阶**，核心内容包括：缓存穿透/击穿/雪崩、分布式锁、排行榜。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“实现缓存保护方案”，形成可运行、可演示、可复盘的阶段成果。
