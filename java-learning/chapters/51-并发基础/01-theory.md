...
本章主题是 **并发基础**，核心内容包括：Thread、Runnable、Callable、线程状态、join。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“模拟多线程下载任务”，形成可运行、可演示、可复盘的阶段成果。
