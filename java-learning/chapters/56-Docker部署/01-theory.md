# Chapter 56 Docker部署 - 理论篇

## 一、学习定位

本章主题是 **Docker部署**，核心内容包括：Dockerfile、Compose、MySQL/Redis 编排、健康检查。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
理解 镜像 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 2. 容器编排

理解 容器编排 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 3. 环境变量

理解 环境变量 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 4. 健康检查

理解 健康检查 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 5. 日志

理解 日志 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。
...
- 完成“一键启动博客项目”，形成可运行、可演示、可复盘的阶段成果。
