# Chapter 25 SQL基础 - 理论篇

## 一、学习定位

本章主题是 **SQL基础**，核心内容包括：表设计、CRUD、约束、索引入门。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“设计用户和文章基础表”，形成可运行、可演示、可复盘的阶段成果。
