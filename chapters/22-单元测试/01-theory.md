...
本章主题是 **单元测试**，核心内容包括：JUnit 5、断言、参数化测试、测试命名。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“为工具库补齐自动化测试”，形成可运行、可演示、可复盘的阶段成果。
