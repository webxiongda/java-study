# Chapter 30 里程碑：博客DAO层 - 理论篇

## 一、学习定位

本章主题是 **里程碑：博客DAO层**，核心内容包括：JDBC/MyBatis/SQL 整合、README、测试。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。
...
- 完成“交付博客数据访问层 v1”，形成可运行、可演示、可复盘的阶段成果。
