# Chapter 31 Spring基础 - 理论篇

## 一、学习定位

本章主题是 **Spring基础**，核心内容包括：IoC、DI、Bean、配置方式、生命周期。它在 Java 后端路线中的作用不是单独记 API，而是把前面学过的 Java 基础逐步落到真实后端项目里。

- 优先级：L1 必须掌握
- 预计投入：4小时
- 阶段产出：完成 Spring Hello World

## 二、核心概念

### 1. IoC 容器

理解 IoC 容器 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 2. 依赖注入

理解 依赖注入 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 3. Bean 生命周期

理解 Bean 生命周期 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 4. 配置方式

理解 配置方式 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。

### 5. 解耦设计

理解 解耦设计 时要同时关注三个问题：它解决什么项目问题、代码里如何落地、面试时如何讲清楚取舍。
...
- 完成“完成 Spring Hello World”，形成可运行、可演示、可复盘的阶段成果。
...
1. Spring基础 解决了 Java 后端项目里的什么问题？
2. 如果本章能力在生产环境出问题，你会从哪些日志、配置或数据开始排查？
3. 本章技术和前后章节的关系是什么？例如它如何服务于博客 API 项目？
4. 你在实现“完成 Spring Hello World”时会如何划分模块，为什么？
